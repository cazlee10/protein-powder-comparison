...
export default function FloatingChat() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 android-floating-chat">
      {/* Chat Button */}
      {!isOpen && (
        <button
          onClick={() => {
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="bg-white rounded-lg shadow-xl w-80 sm:w-96 transition-all duration-200 android-chat-window">
          {/* Header */}
          ...
          {!isMinimized && (
            <>
              <div className="h-96 overflow-y-auto p-4 space-y-4 android-chat-messages">
              ...
              {/* Input Form */}
              <form onSubmit={handleSubmit} className="p-4 border-t android-chat-input">
                <div className="flex gap-2">
                  <input
                    type="text"
                    value={input}
                    ...
                    className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 android-input-field"
                  />
                  <button
                    type="submit"
                    disabled={isLoading}
